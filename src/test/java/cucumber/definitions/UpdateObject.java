...
import response_model.UpdateObjectResponse;
import response_model.GetListAllObjectResponse;
...
public class UpdateObject {
    ...
    public void saveFirstIdOfExistingObject() throws Exception {
        ...
        List<GetListAllObjectResponse> resGetListAll = objectMapper.readValue(AddObject.response.body().asString(),
                new TypeReference<List<GetListAllObjectResponse>>() {
                });
    ...
    public void verifyUpdateResponseHardDiskSize(String hardDiskSize) throws Exception {
        ...
        Assert.assertEquals(updateObjectResponse.get(0).getData().getHardDiskSize(), hardDiskSize,
                "Expected hard disk size " + hardDiskSize + ", but got "
                        + updateObjectResponse.get(0).getData().getHardDiskSize());
    }
    ...
    public void verifyUpdateResponseScreenSize(String screenSize) throws Exception {
        ...
        Assert.assertEquals(updateObjectResponse.get(0).getData().getScreenSize(), screenSize,
                "Expected screen size " + screenSize + ", but got "
                        + updateObjectResponse.get(0).getData().getScreenSize());
    }
